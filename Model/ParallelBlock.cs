...
namespace SqlCLRParallel.Model
{
    ...
    class ParallelBlock
    {
        ...
        private bool _seperatedTransaction = true;
        
        
        public bool InSeperatedTransaction
        {
            get
            {
                return _seperatedTransaction;
            }
        }
        /// <summary>
        ...
        public void Add(string key, string sql,IList<SqlParameter> parameters)
        {
            ...
            //}
            ThreadSql threadSql = new ThreadSql(key, _connectionString, sql, parameters);
        ...
        public void StartTransaction(System.Transactions.IsolationLevel level,bool seperatedTransaction)
        {
            _transactionLevel = level;
            _seperatedTransaction = seperatedTransaction;
        ...
        /// <summary>
        /// Executes sqls in parallel, need to support more wait type
        /// </summary>
        ...
        public int Run(Transaction trans)
        {
            ...
            if (_threads.Count > 0)
            {
                if (_seperatedTransaction)
                {
                    foreach (ThreadSql sql in _threads)
                    {
                        sql.IsolationLevel = _transactionLevel;
                    }
                }else
                {
